...
To run this project, you need to have miniconde installed. You can download and install miniconda from [here](https://repo.anaconda.com/miniconda/Miniconda3-latest-Windows-x86_64.exe)(Windows).
